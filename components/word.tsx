      ...
      >
        ...
        >
          ...
          <List.ul tabIndex={0}>
            <List.li
              tabIndex={0}
            >{`Occurrences of word: ${props.data.count}`}</List.li>
            <List.li
              tabIndex={0}
            >{`Number of retweets featuring word: ${props.data.retweetCount}`}</List.li>
            <List.li
              tabIndex={0}
            >{`Number of favorites featuring word: ${props.data.favoriteCount}`}</List.li>
            <List.li
              tabIndex={0}
            >{`Number of tweets with word: ${props.data.tweetsWithWord}`}</List.li>
          </List.ul>
        </FactBox>
        <FactBox
          style={{ height: "30rem", marginBottom: "1rem" }}
